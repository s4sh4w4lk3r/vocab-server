...
namespace Vocab.Core.Entities
{
    ...
    public class StatementPair(): IEntity
    {
        ...
        [SetsRequiredMembers]
        public StatementPair(long id, string source, string target, StatementCategory statementCategory, int guessingLevel, DateTime lastModified, long relatedDictionaryId) : this()
        {
            Id = id;
            Source = source;
            Target = target;
